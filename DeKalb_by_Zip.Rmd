...
That looks like a pretty clear correlation. We can fit the data to a linear model to express the relation more clearly and to see how substantial and statistically significant it is.   
...
It looks like median income explains about a quarter of the variation between ZIP Codes in DeKalb with a high degree of certainty.
